 ...
 * @tree: A type **pointer of root node of the AVL tree struct.
 * @parent: A parent node of struct AVL.
 * @new: A type**pointer left or right insertion.
 * @nval: A insertion value of the AVL.
